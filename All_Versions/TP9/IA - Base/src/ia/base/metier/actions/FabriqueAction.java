  ...
  public static Action creerMouvement(TypeMouvement mouvement)
    ...
    public static Action creerDemande(TypeDemande demande)
    {
        ...
        switch(demande)
        {
            ...
            case MAGASIN: DemandeAction = new ActionDemande("STORE");
            break;
        }
    ...
    {
        return new ActionRemplir(direction);
    }
