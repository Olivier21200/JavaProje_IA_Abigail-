...
public class Carte  
{
   ...
   /**
    * Constructeur de la carte a partir du message recu.
    * @param messageRecu message recu.
    */ 
   public Carte(String messageRecu) 
   {
      coordonneesMagasin = new ArrayList<Coordonnee>();
        ...
        this.coordonneesMagasin.add(new Coordonnee(this.CoordonneeDepart.GetLigne()+2, this.CoordonneeDepart.GetColonne()-4));
        this.coordonneesMagasin.add(new Coordonnee(this.CoordonneeDepart.GetLigne()+2, this.CoordonneeDepart.GetColonne()-3));

        this.afficheConsole();
   }
        
   /**
    * Opérateur qui ajoute une case en fonction d'un lettre et de coordonnee.
    * @param coordonnee Coordonne de l'ajout.
    * @param lettre Lettre (type de la case).
    */
   private void ajouterCase(Coordonnee coordonnee, Character lettre) 
   {
    ...
    /**
     * Opérateur qui return la taille de la carte
    ...
    /**
     * Opérateur qui return la liste des valeurs stockées dans la HashMap cases
     * @return Valeurs dans le HashMap cases
     */
    ...
    {
        return this.coordonneesMagasin;
    }
