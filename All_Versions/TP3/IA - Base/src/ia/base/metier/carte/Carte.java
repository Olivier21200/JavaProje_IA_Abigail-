...
public class Carte  
{
   ...
   public Carte(String messageRecu) 
   {
        ...
        this.ajouterCase(AffichageObjetEscalier.getVoisin(TypeMouvement.BOTTOM), 'S');
        this.ajouterCase(AffichageObjetEscalier.getVoisin(TypeMouvement.RIGHT), 'S');
        this.ajouterCase(AffichageObjetEscalier.getVoisin(TypeMouvement.LEFT), 'S');
   }
